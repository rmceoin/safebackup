...
public class CryptoIntents {
	...
	/**
	 * Activity Action: Retrieve the full path to the backup filename
	 * 
	 * <p>Constant Value: "org.openintents.action.CRYPTO_GET_BACKUP_NAME"</p>
	 */
	public static final String ACTION_CRYPTO_GET_BACKUP_NAME = "org.openintents.action.CRYPTO_GET_BACKUP_NAME";
